...
# class CodeCivil(db.Model):
#     __tablename__ = 'code_civil'
...
#     def __repr__(self):
#         return f'<CodeCivil {self.article_num}>'

class CodeCivil2(db.Model):
    __tablename__ = 'code_civil2'
    ...
    def __repr__(self):
        return f'<CodeCivil2 {self.article_num}>'
