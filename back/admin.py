...
class SecureModelView(ModelView):
    ...
    def inaccessible_callback(self, name, **kwargs):
        return redirect(url_for('admin_routes.login', next=request.url))  # Redirige vers la page de connexion
...
def create_admin(app):
    ...
    admin.add_view(SecureModelView(UserAdmin, db.session))  # Sécuriser UserAdmin
