import json
from models.models import db, CodePenal1

# Fonction pour insérer un article
def insert_article(article_num, texte):
    try:
        article = CodePenal1(article_num=article_num, texte=texte)
...
def load_and_insert_articles_penale(filename, app_context):
...
#     load_and_insert_articles_penale('articles_code_penale.json')
