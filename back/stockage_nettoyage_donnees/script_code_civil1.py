...
def parse_text_to_structure(text):
    structure = {
        "Loi": {
            "Nom": "Code Civil du Burkina Faso",
            "Titres": []
        }
    }
...
def main():
    ...
    pdf_path = "stockage_nettoyage_donnees/code_civil_1.pdf"
    # Path to save the JSON file
    json_path = "stockage_nettoyage_donnees/code_civil_apres_traitement.json"
